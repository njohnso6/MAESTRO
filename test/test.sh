...
#MAESTRO scatac-peakcount --peak $TEST_PEAK_GZ --filtered_count $TEST_FRAG_GZ --barcode $TEST_BC_GZ --species GRCh38 --cores 1 --outprefix $TEST_PREFIX -d ${TEST1_OUTPUT_DIR} --binary
