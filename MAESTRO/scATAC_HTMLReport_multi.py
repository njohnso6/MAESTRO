...
def main():
    ...
    fragplot_link = snakemake.report.data_uri_from_file("Result/QC/%s/%s_scATAC_fragment_size.png"%(outpre, outpre))
    # mapplot_link = snakemake.report.data_uri_from_file("Result/QC/%s_scATAC_mapping_summary.png"%outpre)[0]
    fripplot_link = snakemake.report.data_uri_from_file("Result/QC/%s/%s_scATAC_cell_filtering.png"%(outpre, outpre))
    peakcluster_link = snakemake.report.data_uri_from_file("Result/Analysis/%s/%s_cluster.png"%(outpre, outpre))
    if os.path.exists("Result/Analysis/%s/%s_annotated.png"%(outpre, outpre)):
        rpannodisplay = "inline"
        rpannotate_link = snakemake.report.data_uri_from_file("Result/Analysis/%s/%s_annotated.png"%(outpre, outpre))
    else:
        rpannodisplay = "none"
        rpannotate_link = ""
    if os.path.exists("Result/Analysis/%s/%s_CistromeTop_annotated.png"%(outpre, outpre)):
        caannodisplay = "inline"
        caannotate_link = snakemake.report.data_uri_from_file("Result/Analysis/%s/%s_CistromeTop_annotated.png"%(outpre, outpre))
    else:
        caannodisplay = "none"
        caannotate_link = ""

    if os.path.exists("Result/Analysis/%s/%s_MS4A1_genetrack.png"%(outpre, outpre)):
        ms4a1display = "inline"
        ms4a1track_link = snakemake.report.data_uri_from_file("Result/Analysis/%s/%s_MS4A1_genetrack.png"%(outpre, outpre))
    else:
        ms4a1display = "none"
        ms4a1track_link = ""

    if os.path.exists("Result/Analysis/%s/%s_CD3D_genetrack.png"%(outpre, outpre)):
        cd3ddisplay = "inline"
        cd3dtrack_link = snakemake.report.data_uri_from_file("Result/Analysis/%s/%s_CD3D_genetrack.png"%(outpre, outpre))
    else:
        cd3ddisplay = "none"
        cd3dtrack_link = ""
    ...
    if input_format != "fragments":
        ...
        readdistrplot_link = snakemake.report.data_uri_from_file("Result/QC/%s/%s_scATAC_read_distr.png"%(outpre, outpre))
